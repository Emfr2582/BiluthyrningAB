...
{
    public partial class BiluthyrningABContext : DbContext
    {
        public BiluthyrningABContext()
        {
        }

        public BiluthyrningABContext(DbContextOptions<BiluthyrningABContext> options)
            : base(options)
        {
        }
